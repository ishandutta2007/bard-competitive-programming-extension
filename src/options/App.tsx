      ...
      <nav className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-semibold">
            CompetitiveProgrammingBARD(v{getExtensionVersion()})
          </span>
        </div>
        <div className="flex flex-row gap-3">
          <a
            href="https://github.com/ishandutta2007/bard-competitive-programming-extension/issues"
            target="_blank"
            rel="noreferrer"
          >
            Feedback
          ...
          <a
            href="https://github.com/ishandutta2007/bard-competitive-programming-stackexchange-extension"
            target="_blank"
            rel="noreferrer"
          >
            Source code
